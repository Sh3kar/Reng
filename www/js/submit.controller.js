...
function SubmitController($scope, $state, ratingConfig) {
  $scope.data = {};
console.log("is it here submit controller?");
  ...
  $scope.usersel = {}; // no default
$scope.name = "click-to-home";
...
SubmitController.$inject = ['$scope', '$state'];
})();
